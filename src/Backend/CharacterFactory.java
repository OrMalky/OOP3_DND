...
public class CharacterFactory {
    ...
    public CharacterFactory() {
        playerCharacters = new LinkedHashMap<PlayerCharacter,Player>(){{
                ...
                put(PlayerCharacter.MELISANDRE, new Mage("Melisandre", 100, 5, 1, 300, 30, 40, 5, 6, new Position2D(0, 0)));
                put(PlayerCharacter.THOROS_OF_MYR, new Mage("Thoros of Myr", 250, 25, 4, 150, 20, 20, 3, 4, new Position2D(0, 0)));
